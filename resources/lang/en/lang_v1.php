...
return [
	...
	"dock_menu" => "Show/hide Menu",
	"dock_up" => "Go Up",
	"dock_Terms" => "terms and conditions",
	"dock_howto" => "How To",
	"dock_Support" => "Support",
	"dock_calendar" => "Calendar",
	"dock_calculator" => "Calculator",
	"dock_Username" => "Username",
	"dock_Tasks" => "Add Task",
	"dock_Clockinout" => "Attendance",
	"dock_users" => "Users",
    "dock_clients" => "Clients",
    "dock_suppliers" => "Suppliers",
    "dock_repaire" => "Repair POS",
    "dock_cashregister" => "Today Report",
    "dock_pos" => "POS",
    "dock_logout" => "Logout",
    "dock_products" => "Products",
    "dock_adproduct" => "Add Product",
    "dock_sales" => "Sales",
    "dock_addsale" => "Add Sale",
    "dock_purchase" => "Purchase",
    "dock_notification" => "Notification",
    ...
    "disable" => 'Disable',
	"importdata" => 'Import Data From Sheet Excel',
	...
	"draft_pos_button" => "Draft",
	"checkout_multi_pay_pos" => "Multi pay",
    ...
    'invoid_pay_statues' => 'Payment Status',
    'invoid_pay_all' => 'All',
    'invoid_pay_Duo' => 'Duo',
    'invoid_pay_partial' => 'Partial',
    'invoid_pay_overduo' => 'OverDuo',
   ...
   'payment_paid_notification' => 'Payment Paid Notification',
	...
	"Rightclick_Home" => "Home",
    "dock_Terms" => "dock_Terms ",

	"RightClick_add_sale" =>        "Add Sale",
	"RightClick_AddProduct" =>     "Add Product",
	"RightClick_purchasecreate" =>   "Add Purchase",
	"RightClick_add_expense" =>      "Add Expense",
	"RightClick_ManageClient" =>     "Manage Clients",
	"RightClick_ManageSupplier" =>   "Manage Suppliers",
	"RightClick_ManageProfile" =>    "Manage Profile",
	"RightClick_Setting" =>          "Setting",
	"RightClick_BassicSetting" =>    "Bassic Setting",

	"RightClick_Support" =>         "Support",
	"RightClick_Logout" =>          "Logout",
