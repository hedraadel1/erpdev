...
<button onclick="location.href='{{ route('login') }}'" class='button-30'>{{ __('business.Reg_BacktoLogin')}} </button>
...
<div style="display:none"  class="col-md-6">
    ...
    <div class="input-group">
        ...
        {!! Form::select('currency_id', $currencies, '142', ['class' => 'form-control select2_register','placeholder' => __('business.currency_placeholder'), 'required']); !!}
    </div>
    </div>
</div>
...
<div style="display:none" class="col-md-6">
    ...
    <div class="input-group">
        ...
        {!! Form::text('country', 'مصر', ['class' => 'form-control','placeholder' => __('business.country'), 'required']); !!}
    </div>
    </div>
</div>
...
<div style="display:none" class="col-md-6">
    ...
    <div class="input-group">
        ...
        {!! Form::text('state', 'مصر', ['class' => 'form-control','placeholder' => __('business.state'), 'required']); !!}
    </div>
    </div>
</div>
<div class="clearfix"></div>
<div style="display:none" class="col-md-6">
    ...
    <div class="input-group">
        ...
        {!! Form::text('city', 'مصر', ['class' => 'form-control','placeholder' => __('business.city'), 'required']); !!}
    </div>
    </div>
</div>
<div style="display:none" class="col-md-6">
    ...
    <div class="input-group">
        ...
        {!! Form::text('zip_code', '11111', ['class' => 'form-control','placeholder' => __('business.zip_code_placeholder'), 'required']); !!}
    </div>
    </div>
</div>
<div class="clearfix"></div>
<div style="display:none" class="col-md-6">
    ...
    <div class="input-group">
        ...
        {!! Form::text('landmark', 'brand', ['class' => 'form-control','placeholder' => __('business.landmark'), 'required']); !!}
    </div>
    </div>
</div>
<div style="display:none" class="col-md-6">
...
@if(empty($is_admin))
    ...
    <legend style="display:none">@lang('business.business_settings'):</legend>
    <div style="display:none" class="col-md-6">
        <div class="form-group">
...
<!-- Owner Information -->
@if(empty($is_admin))
    <h3 style="display:none" >@lang('business.owner')</h3>
@endif


<legend style="display:none" >@lang('business.owner_info')</legend>
