        ...
        <tr>
            <td class="text-center" style="line-height: 15px !important; padding-bottom: 10px !important">
                ...
                @if (!empty($receipt_details->invoice_heading))
                    <p style="font-weight: bold; font-size: 25px !important">{!! $receipt_details->invoice_heading !!}</p>
                @endif
            </td>
        </tr>
                        ...
                        <table class="table table-bordered table-no-top-cell-border table-slim">
                            <thead>
                                <tr style="background-color: #357ca5 !important; color: white !important; font-size: 15px !important"
                                    ...
                                    <td
                                        style="background-color: #357ca5 !important; color: white !important;width: 24% !important;">
                                        {{ $receipt_details->table_unit_price_label }}
                                    </td>
                           
                                    <td
                                        style="background-color: #357ca5 !important; color: rgb(255, 131, 59) !important;width: 17% !important;">
