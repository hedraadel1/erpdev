<table align="center"
    ...
    @foreach ($page_products as $page_product)
        ...
        <td align="center" valign="center">
            <div
                style="overflow: hidden !important;width: {{ $barcode_details->width }}in; height: {{ $barcode_details->height * 0.98 }}in;">
                ...
                @if (!empty($print['business_name']))
                    <b
                        style="display: block !important; font-size: {{ $print['business_name_size'] }}px">{{ $business_name }}</b>
                @endif
                ...
                {{-- Barcode --}}
                <img style="max-width:90%;width:1.25in !important;height: {{ $barcode_details->height * 0.25 }}in !important; display: block;"
                    src="data:image/png;base64,{{ DNS1D::getBarcodePNG($page_product->sub_sku, $page_product->barcode_type, 1, 30, [0, 0, 0], false) }}">
