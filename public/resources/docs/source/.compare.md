...
[Get Postman Collection](http://www.onoo.pro/erp/public/docs/collection.json)
...
```bash
curl -X GET \
    -G "http://www.onoo.pro/erp/public/connector/api/get-attendance/1" \
...
```javascript
const url = new URL(
    "http://www.onoo.pro/erp/public/connector/api/get-attendance/1"
);
...
```bash
curl -X POST \
    "http://www.onoo.pro/erp/public/connector/api/clock-in" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"user_id":1,"clock_in_time":"2000-06-13 13:13:00","clock_in_note":"aspernatur","ip_address":"saepe","latitude":"voluptatem","longitude":"facilis"}'
...
```bash
curl -X POST \
    "http://www.onoo.pro/erp/public/connector/api/clock-out" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"user_id":1,"clock_out_time":"2000-06-13 13:13:00","clock_out_note":"quia","latitude":"minus","longitude":"voluptas"}'
...
```bash
curl -X GET \
    -G "http://www.onoo.pro/erp/public/connector/api/holidays?location_id=1&start_date=2020-06-25&end_date=2020-06-25" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.onoo.pro/erp/public/connector/api/holidays"
);
...
```bash
curl -X GET \
    -G "http://www.onoo.pro/erp/public/connector/api/brand" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.onoo.pro/erp/public/connector/api/brand"
);
...
```bash
curl -X GET \
    -G "http://www.onoo.pro/erp/public/connector/api/brand/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.onoo.pro/erp/public/connector/api/brand/1"
);
...
```bash
curl -X GET \
    -G "http://www.onoo.pro/erp/public/connector/api/business-location" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.onoo.pro/erp/public/connector/api/business-location"
);
...
```bash
curl -X GET \
    -G "http://www.onoo.pro/erp/public/connector/api/business-location/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.onoo.pro/erp/public/connector/api/business-location/1"
);
...
```bash
curl -X GET \
    -G "http://www.onoo.pro/erp/public/connector/api/crm/follow-ups?start_date=2020-12-16&end_date=2020-12-16&status=iste&follow_up_type=voluptatum&order_by=start_datetime&direction=desc&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.onoo.pro/erp/public/connector/api/crm/follow-ups"
);
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"title":"Meeting with client","contact_id":2,"description":"eos","schedule_type":"illo","user_id":"[2,3,5]","notify_before":5,"notify_type":"minute","status":"open","notify_via":"['sms' => 0 ,'mail' => 1]","start_datetime":"2021-01-06 13:05:00","end_datetime":"2021-01-06 13:05:00","followup_additional_info":"['call duration' => '1 hour']","allow_notification":true}'
...
```bash
curl -X GET \
    -G "http://www.onoo.pro/erp/public/connector/api/crm/follow-ups/1,2" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.onoo.pro/erp/public/connector/api/crm/follow-ups/1,2"
);
...
```bash
curl -X PUT \
    "http://www.onoo.pro/erp/public/connector/api/crm/follow-ups/20" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"title":"Meeting with client","contact_id":2,"description":"est","schedule_type":"aut","user_id":"[2,3,5]","notify_before":5,"notify_type":"minute","status":"open","notify_via":"['sms' => 0 ,'mail' => 1]","followup_additional_info":"['call duration' => '1 hour']","start_datetime":"2021-01-06 13:05:00","end_datetime":"2021-01-06 13:05:00","allow_notification":true}'
...
```bash
curl -X GET \
    -G "http://www.onoo.pro/erp/public/connector/api/crm/follow-up-resources" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.onoo.pro/erp/public/connector/api/crm/follow-up-resources"
);
...
```bash
curl -X GET \
    -G "http://www.onoo.pro/erp/public/connector/api/crm/leads?assigned_to=1%2C2%2C3&name=voluptas&biz_name=corrupti&mobile_num=19&contact_id=ut&order_by=laborum&direction=desc&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.onoo.pro/erp/public/connector/api/crm/leads"
);
...
```bash
curl -X POST \
    "http://www.onoo.pro/erp/public/connector/api/crm/call-logs" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"call_logs":[{"mobile_number":"tempore","mobile_name":"ut","call_type":"call","start_time":"placeat","end_time":"rem","duration":"quia"}]}'
...
```bash
curl -X GET \
    -G "http://www.onoo.pro/erp/public/connector/api/cash-register?status=open&user_id=10&start_date=2018-06-25&end_date=2018-06-25&location_id=1&per_page=15" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.onoo.pro/erp/public/connector/api/cash-register"
);
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"location_id":1,"initial_amount":11194493.5494966991245746612548828125,"created_at":"2020-5-7 15:20:22","closed_at":"2020-5-7 15:20:22","status":"close","closing_amount":8887.36100000000078580342233180999755859375,"total_card_slips":11,"total_cheques":11,"closing_note":"libero","transaction_ids":"1,2,3"}'
...
let body = {
    "location_id": 1,
    "initial_amount": 11194493.5494966991245746612548828125,
    "created_at": "2020-5-7 15:20:22",
    "closed_at": "2020-5-7 15:20:22",
    "status": "close",
    "closing_amount": 8887.36100000000078580342233180999755859375,
    "total_card_slips": 11,
    "total_cheques": 11,
    "closing_note": "libero",
...
```bash
curl -X GET \
    -G "http://www.onoo.pro/erp/public/connector/api/cash-register/59" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.onoo.pro/erp/public/connector/api/cash-register/59"
);
...
```bash
curl -X GET \
    -G "http://www.onoo.pro/erp/public/connector/api/contactapi?type=quisquam&name=vero&biz_name=dolore&mobile_num=12&contact_id=vel&order_by=ipsam&direction=ullam&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.onoo.pro/erp/public/connector/api/contactapi"
);
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"type":"customer","supplier_business_name":"debitis","prefix":"tempora","first_name":"rem","middle_name":"at","last_name":"possimus","tax_number":"8787fefef","pay_term_number":3,"pay_term_type":"months","mobile":"4578691009","landline":"5487-8454-4145","alternate_number":"841847541222","address_line_1":"molestias","address_line_2":"magni","city":"quia","state":"saepe","country":"optio","zip_code":"expedita","customer_group_id":"vitae","contact_id":"aliquid","dob":"2000-06-13","custom_field1":"consequatur","custom_field2":"nam","custom_field3":"animi","custom_field4":"error","email":"sit","shipping_address":"voluptatem","position":"ut","opening_balance":0,"source_id":12,"life_stage_id":18,"assigned_to":[]}'
...
let body = {
    ...
    "address_line_1": "molestias",
    "address_line_2": "magni",
    "city": "quia",
    "state": "saepe",
    "country": "optio",
    "zip_code": "expedita",
...
```bash
curl -X GET \
    -G "http://www.onoo.pro/erp/public/connector/api/contactapi/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.onoo.pro/erp/public/connector/api/contactapi/1"
);
...
curl -X PUT \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"type":"customer","supplier_business_name":"veritatis","prefix":"repudiandae","first_name":"rerum","middle_name":"quia","last_name":"nisi","tax_number":"488744dwd","pay_term_number":3,"pay_term_type":"months","mobile":"8795461009","landline":"65484-848-848","alternate_number":"9898795220","address_line_1":"qui","address_line_2":"ipsa","city":"est","state":"aliquid","country":"autem","zip_code":"non","customer_group_id":"quo","contact_id":"hic","dob":"2000-06-13","custom_field1":"itaque","custom_field2":"sit","custom_field3":"deleniti","custom_field4":"consequatur","email":"qui","shipping_address":"sit","position":"consequuntur","opening_balance":10.300000000000000710542735760100185871124267578125,"source_id":1,"life_stage_id":9,"assigned_to":[]}'
...
let body = {
    ...
    "country": "autem",
    "zip_code": "non",
    "customer_group_id": "quo",
    "contact_id": "hic",
    "dob": "2000-06-13",
    "custom_field1": "itaque",
    "custom_field2": "sit",
    "custom_field3": "deleniti",
...
```bash
curl -X POST \
    "http://www.onoo.pro/erp/public/connector/api/contactapi-payment" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"contact_id":17,"amount":453.1299999999999954525264911353588104248046875,"method":"cash","paid_on":"2020-07-22 15:48:29","account_id":5,"card_number":"ipsum","card_holder_name":"earum","card_transaction_number":"minima","card_type":"nemo","card_month":"impedit","card_year":"blanditiis","card_security":"iste","transaction_no_1":"sapiente","transaction_no_2":"voluptate","transaction_no_3":"officia","cheque_number":"molestiae","bank_account_number":"architecto","note":"non"}'
...
```bash
curl -X GET \
    -G "http://www.onoo.pro/erp/public/connector/api/expense?location_id=1&payment_status=paid&start_date=2018-06-25&end_date=2018-06-25&expense_for=enim&per_page=15" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.onoo.pro/erp/public/connector/api/expense"
);
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"location_id":1,"final_total":9842.899999999999636202119290828704833984375,"transaction_date":"2020-5-7 15:20:22","tax_rate_id":14,"expense_for":1,"contact_id":1,"expense_category_id":17,"expense_sub_category_id":19,"additional_notes":"repellendus","is_refund":0,"is_recurring":0,"recur_interval":1,"recur_interval_type":"months","subscription_repeat_on":15,"subscription_no":"atque","recur_repetitions":6,"payment":[{"amount":453.1299999999999954525264911353588104248046875,"method":"cash","account_id":14,"card_number":"sunt","card_holder_name":"laboriosam","card_transaction_number":"quo","card_type":"eligendi","card_month":"at","card_year":"magnam","card_security":"perferendis","transaction_no_1":"dolores","transaction_no_2":"consequatur","transaction_no_3":"rerum","note":"eos","cheque_number":"ut"}]}'
...
let body = {
    "location_id": 1,
    "final_total": 9842.899999999999636202119290828704833984375,
    "transaction_date": "2020-5-7 15:20:22",
    "tax_rate_id": 14,
    "expense_for": 1,
    "contact_id": 1,
    "expense_category_id": 17,
    "expense_sub_category_id": 19,
    "additional_notes": "repellendus",
    "is_refund": 0,
    "is_recurring": 0,
    "recur_interval": 1,
    "recur_interval_type": "months",
    "subscription_repeat_on": 15,
    "subscription_no": "atque",
    "recur_repetitions": 6,
    "payment": [
        {
            "amount": 453.1299999999999954525264911353588104248046875,
            ...
            "account_id": 14,
            "card_number": "sunt",
            "card_holder_name": "laboriosam",
            "card_transaction_number": "quo",
            "card_type": "eligendi",
            "card_month": "at",
            "card_year": "magnam",
...
```bash
curl -X GET \
    -G "http://www.onoo.pro/erp/public/connector/api/expense/59" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.onoo.pro/erp/public/connector/api/expense/59"
);
...
```bash
curl -X PUT \
    "http://www.onoo.pro/erp/public/connector/api/expense/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"final_total":0.94089999999999995861088564197416417300701141357421875,"transaction_date":"2020-5-7 15:20:22","tax_rate_id":5,"expense_for":6,"contact_id":3,"expense_category_id":14,"expense_sub_category_id":9,"additional_notes":"voluptas","is_recurring":0,"recur_interval":5,"recur_interval_type":"months","subscription_repeat_on":15,"subscription_no":"aut","recur_repetitions":9,"payment":[]}'
...
let body = {
    "final_total": 0.94089999999999995861088564197416417300701141357421875,
    "transaction_date": "2020-5-7 15:20:22",
    "tax_rate_id": 5,
    "expense_for": 6,
    "contact_id": 3,
...
```bash
curl -X GET \
    -G "http://www.onoo.pro/erp/public/connector/api/expense-refund?location_id=1&payment_status=paid&start_date=2018-06-25&end_date=2018-06-25&expense_for=doloremque&per_page=15" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.onoo.pro/erp/public/connector/api/expense-refund"
);
...
```bash
curl -X GET \
    -G "http://www.onoo.pro/erp/public/connector/api/expense-categories" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.onoo.pro/erp/public/connector/api/expense-categories"
);
...
```bash
curl -X GET \
    -G "http://www.onoo.pro/erp/public/connector/api/field-force?contact_id=blanditiis&assigned_to=repellat&status=sint&start_date=2018-06-25&end_date=2018-06-25&per_page=15&order_by_date=desc" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.onoo.pro/erp/public/connector/api/field-force"
);

let params = {
    "contact_id": "blanditiis",
...
```bash
curl -X POST \
    "http://www.onoo.pro/erp/public/connector/api/field-force/create" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"contact_id":20,"visit_to":"culpa","visit_address":"voluptates","assigned_to":8,"visit_on":"2021-12-28 17:23:00","visit_for":"sed"}'
...
```bash
curl -X POST \
    "http://www.onoo.pro/erp/public/connector/api/field-force/update-visit-status/17" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"status":"finished","reason_to_not_meet_contact":"et","visited_on":"2021-12-28 17:23:00","visited_address":"Radhanath Mullick Ln, Tiretta Bazaar, Bow Bazaar, Kolkata, West Bengal, 700 073, India","latitude":"41.40338","longitude":"2.17403","comments":"quaerat","photo":"doloremque"}'
...
```bash
curl -X GET \
    -G "http://www.onoo.pro/erp/public/connector/api/product?order_by=exercitationem&order_direction=necessitatibus&brand_id=non&category_id=sunt&sub_category_id=et&location_id=1&selling_price_group=corporis&send_lot_detail=rerum&name=aut&sku=officiis&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.onoo.pro/erp/public/connector/api/product"
);

let params = {
    "order_by": "exercitationem",
    "order_direction": "necessitatibus",
    "brand_id": "non",
    "category_id": "sunt",
    "sub_category_id": "et",
    "location_id": "1",
    "selling_price_group": "corporis",
...
```bash
curl -X GET \
    -G "http://www.onoo.pro/erp/public/connector/api/product/1?selling_price_group=et&send_lot_detail=aperiam" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.onoo.pro/erp/public/connector/api/product/1"
);

let params = {
    "selling_price_group": "et",
    "send_lot_detail": "aperiam",
};
Object.keys(params)
    .forEach(key => url.searchParams.append(key, params[key]));
...
```bash
curl -X GET \
    -G "http://www.onoo.pro/erp/public/connector/api/selling-price-group" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.onoo.pro/erp/public/connector/api/selling-price-group"
);
...
```bash
curl -X GET \
    -G "http://www.onoo.pro/erp/public/connector/api/variation/2?product_id=iure&location_id=1&brand_id=architecto&category_id=laudantium&sub_category_id=sit&not_for_selling=qui&name=magni&sku=assumenda&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.onoo.pro/erp/public/connector/api/variation/2"
);
...
```bash
curl -X GET \
    -G "http://www.onoo.pro/erp/public/connector/api/sell?location_id=1&contact_id=culpa&payment_status=due%2Cpartial&start_date=2018-06-25&end_date=2018-06-25&user_id=ab&service_staff_id=temporibus&shipping_status=ordered&source=quibusdam&only_subscriptions=fugit&send_purchase_details=ea&order_by_date=desc&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.onoo.pro/erp/public/connector/api/sell"
);
...
let params = {
    ...
    "end_date": "2018-06-25",
    "user_id": "ab",
    "service_staff_id": "temporibus",
    "shipping_status": "ordered",
    "source": "quibusdam",
    "only_subscriptions": "fugit",
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"sells":[{"location_id":1,"contact_id":11,"transaction_date":"2020-07-22 15:48:29","invoice_no":"quis","source":"api, phone, woocommerce","status":"final","sub_status":"null","is_quotation":true,"tax_rate_id":1,"discount_amount":10,"discount_type":"fixed","sale_note":"facere","staff_note":"id","commission_agent":17,"shipping_details":"Express Delivery","shipping_address":"fugiat","shipping_status":"ordered","delivered_to":"'Mr robin'","shipping_charges":10,"packing_charge":10,"exchange_rate":1,"selling_price_group_id":17,"pay_term_number":3,"pay_term_type":"months","is_suspend":false,"is_recurring":0,"recur_interval":17,"recur_interval_type":"months","subscription_repeat_on":15,"subscription_no":"occaecati","recur_repetitions":7,"rp_redeemed":17,"rp_redeemed_amount":13.5,"types_of_service_id":17,"service_custom_field_1":"temporibus","service_custom_field_2":"qui","service_custom_field_3":"quas","service_custom_field_4":"nihil","service_custom_field_5":"nobis","service_custom_field_6":"inventore","round_off_amount":5173.4871910000001662410795688629150390625,"table_id":10,"service_staff_id":8,"change_return":0,"products":[{"product_id":17,"variation_id":58,"quantity":1,"unit_price":437.5,"tax_rate_id":0,"discount_amount":0,"discount_type":"percentage","sub_unit_id":19,"note":"dolores"}],"payments":[{"amount":453.1299999999999954525264911353588104248046875,"method":"cash","account_id":8,"card_number":"rerum","card_holder_name":"nesciunt","card_transaction_number":"exercitationem","card_type":"natus","card_month":"cumque","card_year":"vitae","card_security":"sed","transaction_no_1":"excepturi","transaction_no_2":"molestiae","transaction_no_3":"animi","bank_account_number":"facere","note":"et","cheque_number":"sunt"}]}]}'
    ...
    "sells": [
        {
            ...
            "recur_interval_type": "months",
            "subscription_repeat_on": 15,
            "subscription_no": "occaecati",
            "recur_repetitions": 7,
            "rp_redeemed": 17,
            "rp_redeemed_amount": 13.5,
            "types_of_service_id": 17,
            "service_custom_field_1": "temporibus",
            "service_custom_field_2": "qui",
            "service_custom_field_3": "quas",
            "service_custom_field_4": "nihil",
            "service_custom_field_5": "nobis",
            "service_custom_field_6": "inventore",
            "round_off_amount": 5173.4871910000001662410795688629150390625,
            "table_id": 10,
            "service_staff_id": 8,
            "change_return": 0,
            "products": [
            ...
            "payments": [
                {
                    ...
                    "card_transaction_number": "exercitationem",
                    "card_type": "natus",
                    "card_month": "cumque",
                    "card_year": "vitae",
                    "card_security": "sed",
                    "transaction_no_1": "excepturi",
                    "transaction_no_2": "molestiae",
                    "transaction_no_3": "animi",
                    "bank_account_number": "facere",
                    "note": "et",
                    "cheque_number": "sunt"
                }
            ]
...
```bash
curl -X GET \
    -G "http://www.onoo.pro/erp/public/connector/api/sell/55?send_purchase_details=sequi" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.onoo.pro/erp/public/connector/api/sell/55"
);

let params = {
    "send_purchase_details": "sequi",
};
Object.keys(params)
    .forEach(key => url.searchParams.append(key, params[key]));
...
```bash
curl -X PUT \
    "http://www.onoo.pro/erp/public/connector/api/sell/6" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"contact_id":9,"transaction_date":"2020-5-7 15:20:22","status":"final","sub_status":"null","is_quotation":true,"tax_rate_id":9,"discount_amount":10,"discount_type":"fixed","sale_note":"libero","source":"et","staff_note":"corporis","is_suspend":false,"commission_agent":13,"shipping_details":"Express Delivery","shipping_address":"sit","shipping_status":"ordered","delivered_to":"Mr Robin","shipping_charges":10,"packing_charge":10,"exchange_rate":1,"selling_price_group_id":15,"pay_term_number":4,"pay_term_type":"months","is_recurring":0,"recur_interval":9,"recur_interval_type":"days","subscription_repeat_on":7,"subscription_no":"ut","recur_repetitions":1,"rp_redeemed":8,"rp_redeemed_amount":13.5,"types_of_service_id":14,"service_custom_field_1":"iste","service_custom_field_2":"illum","service_custom_field_3":"aut","service_custom_field_4":"qui","service_custom_field_5":"quisquam","service_custom_field_6":"non","round_off_amount":17774.04999999999927240423858165740966796875,"table_id":8,"service_staff_id":13,"change_return":0,"change_return_id":7,"products":[{"sell_line_id":10,"product_id":17,"variation_id":58,"quantity":1,"unit_price":437.5,"tax_rate_id":1,"discount_amount":0,"discount_type":"percentage","sub_unit_id":1,"note":"fugiat"}],"payments":[{"payment_id":3,"amount":453.1299999999999954525264911353588104248046875,"method":"cash","account_id":14,"card_number":"et","card_holder_name":"accusamus","card_transaction_number":"soluta","card_type":"nesciunt","card_month":"odio","card_year":"quisquam","card_security":"excepturi","transaction_no_1":"quae","transaction_no_2":"cum","transaction_no_3":"architecto","note":"soluta","cheque_number":"est","bank_account_number":"incidunt"}]}'
...
let body = {
    ...
    "service_custom_field_1": "iste",
    "service_custom_field_2": "illum",
    "service_custom_field_3": "aut",
    "service_custom_field_4": "qui",
    "service_custom_field_5": "quisquam",
    "service_custom_field_6": "non",
    "round_off_amount": 17774.04999999999927240423858165740966796875,
    "table_id": 8,
    "service_staff_id": 13,
    "change_return": 0,
    "change_return_id": 7,
    ...
    "payments": [
        {
            ...
            "card_transaction_number": "soluta",
            "card_type": "nesciunt",
            "card_month": "odio",
            "card_year": "quisquam",
            "card_security": "excepturi",
            "transaction_no_1": "quae",
            "transaction_no_2": "cum",
            "transaction_no_3": "architecto",
            "note": "soluta",
            "cheque_number": "est",
            "bank_account_number": "incidunt"
        }
    ]
}
...
```bash
curl -X DELETE \
    "http://www.onoo.pro/erp/public/connector/api/sell/soluta" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```bash
curl -X POST \
    "http://www.onoo.pro/erp/public/connector/api/sell-return" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"transaction_id":7,"transaction_date":"2020-5-7 15:20:22","invoice_no":"animi","discount_amount":10,"discount_type":"fixed","products":[{"sell_line_id":5,"quantity":1,"unit_price_inc_tax":437.5}]}'
...
```bash
curl -X GET \
    -G "http://www.onoo.pro/erp/public/connector/api/list-sell-return" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.onoo.pro/erp/public/connector/api/list-sell-return"
);
...
```bash
curl -X POST \
    "http://www.onoo.pro/erp/public/connector/api/update-shipping-status" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"id":19,"shipping_status":"ordered","delivered_to":"eos"}'
...
```bash
curl -X GET \
    -G "http://www.onoo.pro/erp/public/connector/api/active-subscription" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.onoo.pro/erp/public/connector/api/active-subscription"
);
...
```bash
curl -X GET \
    -G "http://www.onoo.pro/erp/public/connector/api/packages" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.onoo.pro/erp/public/connector/api/packages"
);
...
```bash
curl -X GET \
    -G "http://www.onoo.pro/erp/public/connector/api/table?location_id=1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.onoo.pro/erp/public/connector/api/table"
);
...
```bash
curl -X GET \
    -G "http://www.onoo.pro/erp/public/connector/api/table/5" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.onoo.pro/erp/public/connector/api/table/5"
);
...
```bash
curl -X GET \
    -G "http://www.onoo.pro/erp/public/connector/api/tax" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.onoo.pro/erp/public/connector/api/tax"
);
...
```bash
curl -X GET \
    -G "http://www.onoo.pro/erp/public/connector/api/tax/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.onoo.pro/erp/public/connector/api/tax/1"
);
...
```bash
curl -X GET \
    -G "http://www.onoo.pro/erp/public/connector/api/taxonomy?type=impedit" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.onoo.pro/erp/public/connector/api/taxonomy"
);
...
```bash
curl -X GET \
    -G "http://www.onoo.pro/erp/public/connector/api/taxonomy/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.onoo.pro/erp/public/connector/api/taxonomy/1"
);
...
```bash
curl -X GET \
    -G "http://www.onoo.pro/erp/public/connector/api/types-of-service" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.onoo.pro/erp/public/connector/api/types-of-service"
);
...
```bash
curl -X GET \
    -G "http://www.onoo.pro/erp/public/connector/api/types-of-service/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.onoo.pro/erp/public/connector/api/types-of-service/1"
);
...
```bash
curl -X GET \
    -G "http://www.onoo.pro/erp/public/connector/api/unit" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.onoo.pro/erp/public/connector/api/unit"
);
...
```bash
curl -X GET \
    -G "http://www.onoo.pro/erp/public/connector/api/unit/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.onoo.pro/erp/public/connector/api/unit/1"
);
...
```bash
curl -X GET \
    -G "http://www.onoo.pro/erp/public/connector/api/user/loggedin" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.onoo.pro/erp/public/connector/api/user/loggedin"
);
...
```bash
curl -X POST \
    "http://www.onoo.pro/erp/public/connector/api/user-registration" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"surname":"sit","first_name":"quisquam","last_name":"fuga","email":"animi","is_active":"aut","user_type":"consequatur","crm_contact_id":12,"allow_login":true,"username":"cupiditate","password":"accusamus","role":12,"access_all_locations":false,"location_permissions":[],"cmmsn_percent":"non","max_sales_discount_percent":"est","selected_contacts":false,"selected_contact_ids":[],"dob":"dolor","gender":"aliquam","marital_status":"qui","blood_group":"laudantium","contact_number":"mollitia","alt_number":"et","family_number":"quis","fb_link":"maxime","twitter_link":"aut","social_media_1":"sit","social_media_2":"nihil","custom_field_1":"provident","custom_field_2":"ea","custom_field_3":"est","custom_field_4":"consequatur","guardian_name":"et","id_proof_name":"atque","id_proof_number":"id","permanent_address":"culpa","current_address":"ut","bank_details":[{"account_holder_name":"ea","account_number":"tempora","bank_name":"animi","bank_code":"dolor","branch":"laborum","tax_payer_id":"eaque"}]}'
...
let body = {
    ...
    "cmmsn_percent": "non",
    "max_sales_discount_percent": "est",
    "selected_contacts": false,
    "selected_contact_ids": [],
    "dob": "dolor",
    "gender": "aliquam",
    "marital_status": "qui",
    "blood_group": "laudantium",
    "contact_number": "mollitia",
    "alt_number": "et",
    "family_number": "quis",
    "fb_link": "maxime",
    "twitter_link": "aut",
    "social_media_1": "sit",
    "social_media_2": "nihil",
    "custom_field_1": "provident",
    "custom_field_2": "ea",
    "custom_field_3": "est",
    "custom_field_4": "consequatur",
    "guardian_name": "et",
    "id_proof_name": "atque",
    "id_proof_number": "id",
    "permanent_address": "culpa",
    "current_address": "ut",
    "bank_details": [
        {
            "account_holder_name": "ea",
            "account_number": "tempora",
            "bank_name": "animi",
            "bank_code": "dolor",
            "branch": "laborum",
            "tax_payer_id": "eaque"
...
```bash
curl -X GET \
    -G "http://www.onoo.pro/erp/public/connector/api/user?service_staff=facere" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.onoo.pro/erp/public/connector/api/user"
);

let params = {
    "service_staff": "facere",
};
Object.keys(params)
    .forEach(key => url.searchParams.append(key, params[key]));
...
```bash
curl -X GET \
    -G "http://www.onoo.pro/erp/public/connector/api/user/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.onoo.pro/erp/public/connector/api/user/1"
);
...
```bash
curl -X POST \
    "http://www.onoo.pro/erp/public/connector/api/update-password" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"current_password":"dignissimos","new_password":"natus"}'
...
```bash
curl -X POST \
    "http://www.onoo.pro/erp/public/connector/api/forget-password" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"email":"laboriosam"}'
...
```bash
curl -X GET \
    -G "http://www.onoo.pro/erp/public/connector/api/payment-accounts" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.onoo.pro/erp/public/connector/api/payment-accounts"
);
...
```bash
curl -X GET \
    -G "http://www.onoo.pro/erp/public/connector/api/payment-methods" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.onoo.pro/erp/public/connector/api/payment-methods"
);
...
```bash
curl -X GET \
    -G "http://www.onoo.pro/erp/public/connector/api/business-details" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.onoo.pro/erp/public/connector/api/business-details"
);
...
```bash
curl -X GET \
    -G "http://www.onoo.pro/erp/public/connector/api/profit-loss-report?location_id=1&start_date=2018-06-25&end_date=2018-06-25&user_id=1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.onoo.pro/erp/public/connector/api/profit-loss-report"
);
...
```bash
curl -X GET \
    -G "http://www.onoo.pro/erp/public/connector/api/product-stock-report" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.onoo.pro/erp/public/connector/api/product-stock-report"
);
...
```bash
curl -X GET \
    -G "http://www.onoo.pro/erp/public/connector/api/notifications" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.onoo.pro/erp/public/connector/api/notifications"
);
...
```bash
curl -X GET \
    -G "http://www.onoo.pro/erp/public/connector/api/get-location" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
...
```javascript
const url = new URL(
    "http://www.onoo.pro/erp/public/connector/api/get-location"
);
