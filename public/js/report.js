$(document).ready(function() {
    ...
    support_tickets = $('table#support_tickets').DataTable({
        processing: true,
        serverSide: true,
        aaSorting: [
          [0, 'desc']
      ...
      support_admin_tickets = $('table#support_admin_tickets').DataTable({
        processing: true,
        serverSide: true,
        fixedHeader: false,
        aaSorting: [
        ...
        ajax: {
          ...
          data: function (d)
          {
            ...
            var end = $('input#sr_date_filter')
              .data('daterangepicker')
              .endDate.format('YYYY-MM-DD');
            (d.business_id = $('select#sr_business_id').val());
            (d.sr_status = $('select#sr_status').val());
            (d.start_date = start);
            (d.end_date = end);
