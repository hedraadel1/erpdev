...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone'])->group(function () {
  ...
  // Task 1 - Backup Products
  Route::post('/backup-products', 'ProductDbOpController@backupProducts');

  // Task 2 - Restore Products 
  Route::post('/restore-products', 'ProductDbOpController@restoreProducts');

  // Task 3 - Delete Products
  Route::post('/delete-products', 'ProductDbOpController@deleteProducts');

  // Task 6 Route
Route::get('/product-operations', 'ProductDbOpController@viewOperations');    
