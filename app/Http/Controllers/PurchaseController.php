        ...
        if (request()->ajax()) {
            ...
            return Datatables::of($purchases)
                ->addColumn('action', function ($row) {
                    ...
                    $html .= '<li><a href="' . action('LabelsBarcodeController@show') . '?purchase_id=' . $row->id . '" data-toggle="tooltip" title="' . __('lang_v1.label_help') . '"><i class="fas fa-barcode"></i>' . __('barcode.labels') . '</a></li>';
