...
/* 
        $request = new HTTP_Request2('http://pear.php.net/', HTTP_Request2::METHOD_POST);

       // $request = new HTTP_Request2();
        $request->setUrl($sms_settings['url']);
...
if (!empty($sms_settings['param_3'])) {
        $request->addPostParameter(array(
        $request_data[$sms_settings['param_2']] = $sms_settings['param_val_3']
    ));
}
if (!empty($sms_settings['param_4'])) {
    $request->addPostParameter(array(
