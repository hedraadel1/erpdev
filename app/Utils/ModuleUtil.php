...
class ModuleUtil extends Util
{
    ...
    /**
     * This function check if a business has active Server subscription packages
     *
     * @param int $business_id
     * @return boolean
     */
    public function isServerSubscribed($business_id)
    {
        if ($this->isSuperadminInstalled()) {
            $package = \Modules\Superadmin\Entities\ServerSubscriptions::active_ServerSubscriptionstion($business_id);
