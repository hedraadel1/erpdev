        		...
        		<div class="row">
        			<div class="col-md-4">
		               <div class="form-group">
		                    {!! Form::label('follow_up_by', __('crm::lang.follow_up_for') .':*') !!} @show_tooltip(__('crm::lang.follow_up_help'))
		                    <select name="follow_up_by_value" class="form-control" id="recur_follow_up_by" required>
	                    		<option value="">@lang('messages.please_select')</option>
							  	<optgroup label="@lang('lang_v1.invoid_pay_statues')">
							    	<option value="all" data-category="payment_status">@lang('lang_v1.invoid_pay_all')</option>
							    	<option value="due" data-category="payment_status">@lang('lang_v1.invoid_pay_Duo')</option>
							    	<option value="partial" data-category="payment_status">@lang('lang_v1.invoid_pay_partial')</option>
							    	<option value="overdue" data-category="payment_status">@lang('lang_v1.invoid_pay_overduo')</option>
							  	</optgroup>
