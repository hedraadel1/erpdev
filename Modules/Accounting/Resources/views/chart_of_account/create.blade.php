                                        ...
                                        <div class="row gy-4">
                                            <div class="col-md-12">
                                                ...
                                                <div class="form-group">
                                                    <label for="account_type" class="control-label">{{ trans_choice('accounting::lang.account_type', 1) }}
                                                        </label>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="account_subtype_id"
                                                        class="control-label">{{ trans_choice('accounting::lang.Subaccount', 1) }}</label>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="detail_type_id" class="control-label">
                                                        {{ trans_choice('accounting::lang.account_Details', 1) }}</label>
