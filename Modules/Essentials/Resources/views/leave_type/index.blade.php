@extends('layouts.app')
@section('title', __('essentials::lang.leave_typemenu'))

@section('content')
@include('essentials::layouts.nav_hrm')
<section class="content-header">
    <h1>@lang('essentials::lang.leave_typemenu')
    </h1>
</section>
<!-- Main content -->
<section class="content">
    @component('components.widget', ['class' => 'box-solid', 'title' => __( 'essentials::lang.leave_typemenu' )])
        @slot('tool')
            <div class="box-tools">
