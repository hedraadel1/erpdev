...
<section class="content">
	...
	<div class="row row-custom">
		<div class="col-md-4 col-sm-6 col-xs-12 col-custom">
			<div style="width:325px !important;height:253px !important ;" class="card card-gray-Info">
					<div style="height: 48px !important" class="box-header with-border">
                ...
                <div class="box-body p-10">
                    <table class="table no-margin">
                    	<thead>
                    		<tr>
                    			<td>
                    				<h5>@lang('essentials::lang.target_achieved_last_month'):
                    				</h5>
                    				<h5 class="text-success">@format_currency($target_achieved_last_month)</h5>
                    			</td>
                    			<td>
                    				<h5>@lang('essentials::lang.target_achieved_this_month'):
                    				</h5>
                    				<h5 class="text-success">@format_currency($target_achieved_this_month)</h5>
                    			</td>
                    		</tr>
                    		<tr>
                    			<th>
        ...
        <div class="col-md-4 col-sm-6 col-xs-12 text-center ">
            <a style="width:325px !important;height:253px !important;" href="{{action('\Modules\Essentials\Http\Controllers\PayrollController@getMyPayrolls')}}"
                class="btn btn-lg btn-success card card-gray-Info">
	    ...
	    <div class="col-md-4 col-sm-6 col-xs-12 col-custom">
	        <div style="width:325px !important;height:253px !important;" class="card card-gray-Info">
				<div style="height: 48px !important" class="box-header with-border">
	                ...
	                <h3 class="box-title">{{ __('user.TotalUsers') }}</h3>
					<h3 class="box-title">({{$users->count()}})</h3>
	            </div>
    	...
    	<div class="col-md-4 col-sm-6 col-xs-12 col-custom">
            <div style="width:325px !important;height:253px !important;" class="card card-gray-Info">
                ...
                <div class="box-body p-10">
                    <table class="table no-margin">
                        <tr>
                            <th class="" colspan="2">@lang('home.today')</th>
                        </tr>
                        ...
                        <tr>
                            <th class="" colspan="2">@lang('lang_v1.upcoming')</th>
                        </tr>
