@extends('layouts.app')
@section('title', __('superadmin::lang.brand_store'))
@section('css')
...
@section('content')
    ...
    <!-- Main content -->
    <section class="content" id="Brand-Store">
                ...
                <div class="col-md-3">
                    <div class="box">
                        ...
                        <div class="box-body " style="padding: 7px">
                            ...
                            @if (in_array($item->id, $business_products_ids))
                                <span class="w3-tag w3-blue w3-padding"
                                    style="position: absolute;top: 0px;right:-2px;padding: 5px;">
                                    تم الشراء
                                </span>
                            @endif
                        </div>
