...
@section('content')
  ...
  {{--       @component('components.widget', ['title' => __('superadmin::lang.packages')])
            @include('superadmin::serversubscription.partials.packages')
        @endcomponent --}}
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('#all_subscriptions_table').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{{ action('\Modules\Superadmin\Http\Controllers\Server_SubscriptionsController@allSubscriptions') }}',
                columns: [{
                        data: 'server_name',
                        name: 'P.server_name'
                    },
